...
public class UtilitaireRegions {
     ...
     */
    /**
     * Recherche le meilleur chemin vers le dossier Assets.
     */
    private static String trouverRegionDir() {
        String[] chemins = {
            "../Assets/Region/",      // Depuis Partie_ACL/java
            "Partie_ACL/Assets/Region/", // Depuis la racine
            "Assets/Region/",           // Autre cas
            "./Assets/Region/"
        };
        for (String c : chemins) {
            if (new File(c).exists()) return c;
        }
        return chemins[0]; // Par défaut
    }

    private static final String REGION_DIR = trouverRegionDir();
